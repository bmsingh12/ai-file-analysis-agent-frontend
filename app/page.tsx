...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-linear-to-br from-slate-950 via-slate-900 to-cyan-950 text-white rounded-3xl">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-6 lg:grid-cols-[380px_minmax(0,1fr)]">
          ...
          <section className="flex min-h-175 flex-col rounded-3xl border border-white/10 bg-white/5 shadow-2xl shadow-cyan-950/20 backdrop-blur-sm">
